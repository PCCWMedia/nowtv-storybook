import{N as d}from"./NavItem-BKWanS7x.js";import"./jsx-runtime-D_zvdyIk.js";import"./iframe-nMTwWxDm.js";const{fn:a}=__STORYBOOK_MODULE_TEST__,g={title:"Components/NavigationBar/DesktopNav/NavItem",component:d,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{onClick:{action:"clicked"}}},e={args:{label:"Support",href:"#",onClick:a()}},r={args:{label:"Support",href:"#",className:"active",onClick:a()}},o={args:{label:"Subscribe",dropdownItems:[{href:"#",label:"New Customer"},{href:"#",label:"Existing Customer"},{href:"#",label:"Now E Customer"}],onClick:a()}};var n,s,t;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: {
    label: 'Support',
    href: '#',
    onClick: fn()
