import{j as r}from"./jsx-runtime-D_zvdyIk.js";import"./iframe-Kg9Sm9QE.js";import{N as a}from"./NavItem-Dm6-yu1M.js";const i=({items:n,className:s=""})=>r.jsx("ul",{className:`nav-item-list ${s}`,children:n.map((e,t)=>r.jsx(a,{href:e.href,label:e.label,dropdownItems:e.dropdownItems,className:e.className,buttonClass:e.buttonClass},t))});i.__docgenInfo={description:"",methods:[],displayName:"NavItemList",props:{items:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    href?: string;
    label: string;
    dropdownItems?: Array<{
        href: string;
